...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    ...
    <!--熟料储存及熟料汽车胶带机运行-->
    <div class="imageContainer equipmentInfo" data-equipmentid="clinkerStorageBeltMachine" id="zc_nxjc_byc_byf_cementmill01>clinkerStorageBeltMachine>RunningState" style="position:absolute; height: 20px; width: 19px; top: 263px; left: 11px;"></div>
    <!--石膏破碎机运行-->
