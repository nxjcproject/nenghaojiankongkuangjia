...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    <div id="SubMonitorLayout" style="position: relative; background-image: url('../../images/page/zc_nxjc_qtx_tys_clinker05_shu.png'); width: 1350px; height: 740px; overflow: hidden;">
        ...
        <table class="mytable" style="position: absolute; top: 530px; left: 234px;">
            ...
            <tr>
                <td><span id="zc_nxjc_qtx_tys_clinker05>clinker_PulverizedCoalOutput>Day" class="mchart"></span></td>
            </tr>
            <tr>
        ...
        <table class="mytable" style="position: absolute; top: 531px; left: 159px;">
            ...
            <tr>
                <td><span id="zc_nxjc_qtx_tys_clinker05>clinker_PulverizedCoalOutput>Class" class="mchart"></span></td>
            </tr>
            <tr>
        ...
        <table class="mytable" style="position: absolute; top: 532px; left: 86px;">
            ...
            <tr>
                <td><span id="zc_nxjc_qtx_tys_clinker05>clinker_PulverizedCoalOutput>Material" class="mchart"></span></td>
            </tr>
            <tr>
        ...
        <table class="mytable" style="position: absolute; top: 622px; left: 87px;">
            ...
            <tr>
                <td><span id="zc_nxjc_qtx_tys_clinker05>clinker_ClinkerOutput>Material" class="mchart"></span></td>
            </tr>
            <tr>
        ...
        <table class="mytable" style="position: absolute; top: 622px; left: 160px;">
            ...
            <tr>
                <td><span id="zc_nxjc_qtx_tys_clinker05>clinker_ClinkerOutput>Class" class="mchart"></span></td>
            </tr>
            <tr>
        ...
        <table class="mytable" style="position: absolute; top: 622px; left: 235px;">
            ...
            <tr>
                <td><span id="zc_nxjc_qtx_tys_clinker05>clinker_ClinkerOutput>Day" class="mchart"></span></td>
            </tr>
            <tr>
