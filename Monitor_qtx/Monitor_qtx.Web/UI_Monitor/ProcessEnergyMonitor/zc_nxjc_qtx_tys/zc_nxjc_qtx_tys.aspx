...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    <div id="SubMonitorLayout" style="position: relative; background-image: url('../../images/page/zc_nxjc_qtx_tys.png'); width: 1350px; height: 740px; overflow: hidden;">
        ...
        <table class="mytable" style="position: absolute; top: 75px; left: 258px;">
            ...
            <tr>
                <td><span id="zc_nxjc_qtx_tys_clinker04>clinker_MixtureMaterialsOutput>Month" class="mchart"></span></td>
            </tr>
        </table>
        <%--煤粉制备--%>
        ...
        <table class="mytable" style="position: absolute; top: 237px; left: 790px;">
            <tr>
                <td><span id="zc_nxjc_qtx_tys_clinker04>clinker_PulverizedCoalOutput>Class" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_qtx_tys_clinker04>clinker_PulverizedCoalOutput>Day" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_qtx_tys_clinker04>clinker_PulverizedCoalOutput>Month" class="mchart"></span></td>
            </tr>
        </table>
        <%--混合材制备--%>
        ...
        <table class="mytable" style="position: absolute; top: 263px; left: 1061px; height: 50px;">
            ...
            <tr>
                <td><span id="zc_nxjc_qtx_tys_cementmill04>cement_CementOutput>Month" class="mchart"></span></td>
            </tr>
        </table>
        <%--水泥粉磨--%>
        <%--熟料产量--%>
        <table class="mytable" style="position: absolute; top: 291px; left: 290px;">
            <tr>
                <td><span id="zc_nxjc_qtx_tys_clinker04>clinker_ClinkerOutput>Class" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_qtx_tys_clinker04>clinker_ClinkerOutput>Day" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_qtx_tys_clinker04>clinker_ClinkerOutput>Month" class="mchart"></span></td>
            </tr>
        </table>
        <%--水泥包装--%>
       ...
       <%--煤粉消耗量--%>
        ...
        <table class="mytable" style="position: absolute; top: 367px; left: 255px;">
            <tr>
                <td><span id="zc_nxjc_qtx_tys_clinker05>clinker_MixtureMaterialsOutput>Class" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_qtx_tys_clinker05>clinker_MixtureMaterialsOutput>Day" class="mchart"></span></td>
            </tr>
            <tr>
                <td><span id="zc_nxjc_qtx_tys_clinker05>clinker_MixtureMaterialsOutput>Month" class="mchart"></span></td>
            </tr>
        </table>
        <%--煤粉制备--%>
        ...
        <table class="mytable" style="position: absolute; top: 533px; left: 790px;">
            ...
            <tr>
                <td><span id="zc_nxjc_qtx_tys_clinker05>clinker_PulverizedCoalOutput>Month" class="mchart"></span></td>
            </tr>
        </table>
        <%--混合材制备--%>
        ...
        <table class="mytable" style="position: absolute; top: 553px; left: 1065px; height: 50px;">
            ...
            <tr>
                <td><span id="zc_nxjc_qtx_tys_cementmill05>cement_CementOutput>Month" class="mchart"></span></td>
            </tr>
        </table>
        <%--水泥粉磨--%>
        <%--熟料产量--%>
        <table class="mytable" style="position: absolute; top: 676px; left: 646px;">
            ...
            <tr>
                <td><span id="zc_nxjc_qtx_tys_clinker05>clinker_ClinkerOutput>Month" class="mchart"></span></td>
            </tr>
        </table>
        <%--水泥包装--%>
       ...
       <%--煤粉消耗量--%>
        <table class="mytable" style="position: absolute; top: 677px; left: 900px; right: 384px;">
            ...
            <tr>
                <td><span id="zc_nxjc_qtx_tys_clinker05>clinker_PulverizedCoalInput>Month" class="mchart"></span></td>
            </tr>
        </table>
        <%--煤耗--%>
