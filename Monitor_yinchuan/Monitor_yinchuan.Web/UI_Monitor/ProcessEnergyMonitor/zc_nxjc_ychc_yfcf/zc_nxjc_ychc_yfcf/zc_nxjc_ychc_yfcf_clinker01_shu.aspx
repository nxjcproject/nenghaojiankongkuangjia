...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
   ...
   <%--窑尾排风机--%>
        <table class="mytable" style="position: absolute; top: 275px; left: 45px;">
            <tr>
        ...
        <%--F6风机--%>
        <table class="mytable" style="position: absolute; top: 683px; left: 548px;">
            <tr>
  ...
  <!--F12风机-->
    ...
    <!--槽式输送机-->
    <div class="imageContainer equipmentInfo" data-equipmentid="clinkerChainConveyor" id="zc_nxjc_ychc_yfcf_clinker01>clinkerChainConveyor>RunningState" style="position: absolute;  height: 20px; width: 19px; top: 537px; left: 1210px;"></div>
   <!--提升机---->
  ...
  <!--1罗茨风机-->
    <div class="imageContainer equipmentInfo" data-equipmentid="coalMilRootsBlower1" id="zc_nxjc_ychc_yfcf_clinker01>coalMilRootsBlower1>RunningState" style="position: absolute; height: 20px; width: 19px; top: 271px; left: 1003px;"></div>
  <!--2罗茨风机-->
  ...
  <!--3罗茨风机-->
    <div class="imageContainer equipmentInfo" data-equipmentid="coalMilRootsBlower3" id="zc_nxjc_ychc_yfcf_clinker01>coalMilRootsBlower3>RunningState" style="position: absolute; height: 20px; width: 19px; top: 270px; left: 1170px;"></div>
