...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    ...
    <%--1#混合材制备--%>
        ...
        <table class="mytable" style="position: absolute; top: 294px; left: 878px;">
         ...
         <!--  水泥产量-->
        <table class="mytable" style="position: absolute; top: 329px; left: 990px; height: 50px;">
            <tr>
        ...
        <table class="mytable" style="position: absolute; top: 613px; left: 1150px;">
            <tr>
        ...
        <table class="mytable" style="position: absolute; top: 409px; left: 1281px;">
            <tr>
        ...
        <table class="mytable" style="position: absolute; top: 673px; left: 1146px;">
            <tr>
        ...
        <table class="mytable" style="position: absolute; top: 563px; left: 988px; height: 50px;">
         ...
         <!--  水泥包装-->
        <table class="mytable" style="position: absolute; top: 240px; left: 1215px; bottom: 440px;">
            <tr>
                <td>&nbsp;</td>
            </tr>
            <tr>
        ...
        <table class="mytable" style="position: absolute; top: 241px; left: 1281px; height: 20px;">
            <tr>
        ...
        <table class="mytable" style="position: absolute; top: 434px; left: 90px;">
            <tr>
        ...
        <span id="zc_nxjc_ychc_yfcf>cementPacking_ElectricityQuantity>Class" class="mchart"></span>
