...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    ...
    <div class="imageContainer equipmentInfo" data-equipmentid="rawMaterialDustCollectingFan" id="zc_nxjc_ychc_yfcf_clinker01>rawMaterialDustCollectingFan>RunningState" style="position: absolute; height: 20px; width: 19px; top: 291px; left: 200px;"></div>
      <!--皮带131.04-->
    <div class="imageContainer equipmentInfo" data-equipmentid="ingredientsTapeMachine2" id="zc_nxjc_ychc_yfcf_clinker01>ingredientsTapeMachine2>RunningState" style="position: absolute; height: 20px; width: 19px; top: 200px; left: 129px;"></div>
    <!--210.29-->
