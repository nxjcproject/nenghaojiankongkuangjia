...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    <div id="SubMonitorLayout" style="position: relative; background-image: url('../../images/page/zc_nxjc_ychc_lsf_clinker02_shu.png'); width: 1350px; height: 740px; overflow: hidden;">
        ...
        <%--高温风机--%>
        <table class="mytable" style="position: absolute; top: 515px; left: 69px;">
            <tr>
        ...
        <%--F2风机--%>
        <table class="mytable" style="position: absolute; top: 564px; left: 593px;">
            <tr>
        ...
        <%--F3风机--%>
        <table class="mytable" style="position: absolute; top: 564px; left: 659px;">
            <tr>
        ...
        <%--F5风机--%>
        <table class="mytable" style="position: absolute; top: 564px; left: 788px;">
            <tr>
