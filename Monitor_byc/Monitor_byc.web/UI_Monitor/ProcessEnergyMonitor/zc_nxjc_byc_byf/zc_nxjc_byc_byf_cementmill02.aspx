...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
    ...
    <!--2#磨选粉机变频控制柜运行-->
    <div class="imageContainer" id="zc_nxjc_byc_byf_cementmill02>F_2M25ACRN>RunningState" style="position:absolute; height: 20px; width: 19px; top: 336px; left: 695px;"></div>
    <!--2#磨排风机运行-->
    <div class="imageContainer" id="zc_nxjc_byc_byf_cementmill02>F_2M8MRN>RunningState" style="position:absolute; height: 20px; width: 19px; top: 125px; left: 888px;"></div>
    <!--2#磨辊压机定辊运行-->
