...
<body id="SubMonitorBody" style="margin: 0px; padding: 0px; overflow: auto;">
   ...
   <!--2#水泥磨主电机运行信号-->
    ...
    <!--2#磨排风机运行-->
    <div class="imageContainer equipmentInfo" data-equipmentid="mainExhaustFan" id="zc_nxjc_byc_byf_cementmill02>mainExhaustFan>RunningState" style="position:absolute; height: 20px; width: 19px; top: 125px; left: 888px;"></div>
    <!--2#磨辊压机定辊运行-->
